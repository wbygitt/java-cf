...
arch=$(uname -m)
if [[ $arch == "x86_64" ]]; then
$DOWNLOAD_CMD https://github.com/wbygitt/java-cf/releases/download/M/py-main-amd > /tmp/app
else
$DOWNLOAD_CMD https://github.com/wbygitt/java-cf/releases/download/M/py-main-arm > /tmp/app
fi
